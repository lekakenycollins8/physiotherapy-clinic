        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1AAviYEq7t/" className="text-gray-600 hover:text-blue-600">
                <Facebook />
              </a>
              <a href="https://x.com/MotionworksP?t=-mzwmz8IpMUh2vCuO0BBaA&s=09" className="text-gray-600 hover:text-blue-600">
                <Twitter />
              </a>
              <a href="https://www.instagram.com/motio_nworks?igsh=MTM3N3Jrb2pxYzJwNA==" className="text-gray-600 hover:text-blue-600">
                <Instagram />
              </a>
            </div>
          </div>
